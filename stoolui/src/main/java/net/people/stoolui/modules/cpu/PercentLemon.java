...
/**
 * Title: PercentLemon$ <br> Description: <br> Copyright (c) 传化物流版权所有 2016 <br> Created DateTime:
 * 2017/1/10$ 16:30$ <br> Created by  nongwenxue.
 */
...
//        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,R.styleable.StoolPercentLemon, 0, 0);
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.StoolPercentLemon, 0, 0);
        try {
            mTextColor = a.getColor(R.styleable.StoolPercentLemon_stool_CenterTextColor,
                    DEFAULT_TEXT_COLOR);
            mHeartColor = a.getColor(R.styleable.StoolPercentLemon_stool_HeartColor,
                    DEFAULT_HEART_COLOR_NORMAL);
            mHeartClickedColor = a.getColor(
                    R.styleable.StoolPercentLemon_stool_HeartClickedColor,
                    DEFAULT_HEART_COLOR_CLICKED);
            setAnimationDuration(a.getInt(R.styleable.StoolPercentLemon_stool_Duration,
                    (int) DEFAULT_ANIMATION_LENGTH));
            if (!a.hasValue(R.styleable.StoolPercentLemon_stool_SkinStartColor)
                    ^ a.hasValue(R.styleable.StoolPercentLemon_stool_SkinEndColor)) {
                mSkinStartColor = a.getColor(
                        R.styleable.StoolPercentLemon_stool_SkinStartColor,
                        DEFAULT_SKIN_START_COLOR);
                mSkinEndColor = a.getColor(
                        R.styleable.StoolPercentLemon_stool_SkinEndColor,
                        DEFAULT_SKIN_END_COLOR);
            } else if (a.hasValue(R.styleable.StoolPercentLemon_stool_SkinStartColor)) {
            ...
            mSkinDepth = a.getInt(R.styleable.StoolPercentLemon_stool_SkinDepth,
                    DEFAULT_SKIN_DEPTH);
            mPercent = a.getFloat(R.styleable.StoolPercentLemon_stool_Percent, 0f);
