...
public class MainActivity extends AppCompatActivity {
    ...
    private Button mSnow;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        mSnow = (Button) findViewById(R.id.snow);
        mSnow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setContentView(R.layout.snow_main);
            }
        });
        ...
        mBtn_enter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, net.people.stoolui.main.MainActivity.class);
                startActivity(intent);
                Toast.makeText(MainActivity.this, "enter2" + intent.toString(), Toast.LENGTH_SHORT).show();
